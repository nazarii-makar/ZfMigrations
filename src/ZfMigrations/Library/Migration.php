...
use ZfMigrations\Model\MigrationVersion;
use ZfMigrations\Model\MigrationVersionTable;
...
class Migration
{
     ...
     * @param array $config
     * @param \ZfMigrations\Model\MigrationVersionTable $migrationVersionTable
            ...
            if (preg_match('/(Version(\d+))\.php/', $item->getFilename(), $matches)) {
                ...
                if ($all || !$applied) {
                    ...
                    if (class_exists($className)) {
                        ...
                        if ($reflectionClass->implementsInterface('ZfMigrations\Library\MigrationInterface')) {
