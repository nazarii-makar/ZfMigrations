    ...
    BootstrapListenerInterface
{
    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                'ZfMigrations\Model\MigrationVersionTable' => function (ServiceLocatorInterface $serviceLocator) {
                        /** @var $tableGateway TableGateway */
                        $tableGateway = $serviceLocator->get('ZfMigrationsVersionTableGateway');
                        $table = new Model\MigrationVersionTable($tableGateway);
                        return $table;
                    },
                'ZfMigrationsVersionTableGateway' => function (ServiceLocatorInterface $serviceLocator) {
